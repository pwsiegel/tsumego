...
Usage:
    uv --directory api run --extra ml python -m goapp_api.train_board
"""
...
def main() -> None:
    ...
    ap.add_argument("--base-model", type=str, default="yolov8n.pt",
                    help="starting weights (e.g. an existing board_detector.pt "
                         "to fine-tune instead of training from scratch)")
    args = ap.parse_args()
